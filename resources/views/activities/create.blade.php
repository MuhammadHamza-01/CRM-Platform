...
<div class="max-w-2xl mx-auto">
    <div class="rounded-xl" style="background-color:#1E293B; border:1px solid #334155;">
        ...
        <div class="px-6 py-4 flex items-center gap-3" style="border-bottom:1px solid #334155;">
            ...
            <h3 class="font-semibold" style="color:#E5E7EB;">Log New Activity</h3>
        </div>

        <form action="{{ route('activities.store') }}" method="POST" class="px-6 py-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    placeholder="Add any notes, outcomes, or details..."
            ...
            <div>
                ...
                <input type="datetime-local" name="follow_up_date"
                    ...
                    onblur="this.style.borderColor='#334155'; this.style.boxShadow='none'">
                <p class="mt-1 text-xs" style="color:#94A3B8;">Set a reminder date to follow up on this activity.</p>
            </div>
...
function updateTypeCards() {
    ...
    Object.keys(typeColors).forEach(key => {
        ...
        if (!card) return;
        if (key === selected) {
            card.style.backgroundColor = typeColors[key].bg;
            card.style.borderColor     = typeColors[key].color;
        } else {
